		...
		<div class="col-md-10 offset-md-1">
			...
			<div class="user-comment mb-10">
				<div class="user-comment-wrap">
					<div class="user-comment-wrap__title"><a class="user-comment-wrap__link" href="#!" target="_blanck">Поездка
							в LA</a></div>
					<div class="user-comment-wrap__date"><i class="far fa-clock user-comment-wrap__icon"></i>05 Мая 2017
						года в 15:45
					</div>
				</div>
			...
			<div class="user-comment mb-10">
				<div class="user-comment-wrap">
					<div class="user-comment-wrap__title"><a class="user-comment-wrap__link" href="#!" target="_blanck">Ноутбук
							для веб-разработчика</a></div>
					<div class="user-comment-wrap__date"><i class="far fa-clock user-comment-wrap__icon"></i>15 Мая 2017
						года в 10:02
					</div>
				</div>
				<div class="user-comment__content">Замечательный парк, обязательно отправлюсь туда этим летом.</div>
			...
			<div class="user-comment">
				<div class="user-comment-wrap">
					<div class="user-comment-wrap__title"><a class="user-comment-wrap__link" href="#!" target="_blanck">Настройка
							Sublime</a></div>
					<div class="user-comment-wrap__date"><i class="far fa-clock user-comment-wrap__icon"></i>12 Мая 2017
						года в 20:39
					</div>
				</div>
				<div class="user-comment__content">Замечательный парк, обязательно отправлюсь туда этим летом.</div>
